              ...
              <?php
                ...
                while($row_colab = mysqli_fetch_assoc($res_colab)){
                  ...
                  echo "<tr>
                        ...
                        <td><a href=\"detalle_colab.php?i={$ID_Empleado}\" class=\"waves-effect waves-light btn-small\">Detalle</a></td>
                        <td><a href=\"formato_vac.php?i={$ID_Empleado}\" class=\"green darken-3 btn-small\">Formato</a></td>
                      </tr>";
                }
